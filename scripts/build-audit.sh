...
readonly REQUIRED_WINE_TAIL='0098-winex11-isolate-held-LMB-control-motion-from-gestures.patch'
...
0098|ascii|lib/wine/x86_64-unix/winex11.so|held LMB control drag forwards one processed delta
