...
readonly REQUIRED_PIPEASIO_TAIL='pipeasio/0013-classify-pipeasio-forcers-by-bound-node-id.patch'
...
pipeasio/0013|ascii|lib/wine/x86_64-unix/pipeasio.dll.so|pipeasio-node-arbitration
'
