...
readonly REQUIRED_WINE_TAIL='0102-dwrite-use-outlines-for-cleartype-glyphs.patch'
...
0102|ClearType uses glyph outlines. The audit checks the patch and patch list.
'
