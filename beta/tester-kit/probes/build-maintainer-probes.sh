...
wine_source="${WORKS_RUNTIME_SOURCE:-}"
[ -n "$wine_source" ] || { echo "!! set WORKS_RUNTIME_SOURCE to the wine-d2d1-nspa source tree (with build-wow64/, or point ABLETON_WINE_BUILD at the build dir)" >&2; exit 1; }
